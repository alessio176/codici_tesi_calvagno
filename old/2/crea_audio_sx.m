function wavesynt = crea_audio_sx(opt)
...
N = round( (1/opt.freq_base_sx) * opt.fc_audio); 

%uso l' oggetto di tipo audioOscillator per generare il beep fondamentale,
%in modo semplice e intuitivo.
osc = audioOscillator('SignalType','sine','Frequency',opt.freq_base_sx,...
...
wavesynt = wavetableSynthesizer(wavetable,'Frequency',opt.freq_rip_sx,'SamplesPerFrame',N*2,...
